...
<%@ include file="/resources/template/headerClient.html"%>
		<div class="panel panel-default">
			...
			<div class="panel-body " align="center">
				<b>Date de depart </b>: ${voyageSelect.dateD} - <b>Date de
					retour</b> : ${voyageSelect.dateR} <br /> <b>Nombre de places </b>:
		...
		<form:form cssClass="form-horizontal" action="continuerReservation"
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-default">Continuer la
						réservation</button>
				</div>
			</div>
		</form:form>
