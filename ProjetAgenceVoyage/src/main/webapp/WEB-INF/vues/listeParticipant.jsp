...
<body>
	<div style="background-color: #FFEBCD">
		...
		<%@ include
			file="/resources/template/headerParticipantConseiller.html"%>
			...
			<table class="table table-bordered">
				...
				<c:forEach var="p" items="${listeParticipant}">
					<tr>
						...
						<td>${p.client.id}</td>
						<td><a
							href="<c:url value = '/conseiller/pCTRL/deleteLink/${p.id}' />">Supprimer</a>
							| <a
							href="<c:url value = '/conseiller/pCTRL/updateLink?pId=${p.id}' />">Modifier</a></td>
					</tr>
