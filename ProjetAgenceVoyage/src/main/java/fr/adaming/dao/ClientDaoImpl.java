...
public class ClientDaoImpl implements IClientDao {
	...
	public int updateClient(Client cl) {
		...
		// Création de la requête
		String req="UPDATE Client cl SET cl.nom=:pNom, cl.prenom=:pPrenom, cl.civilite=:pCivilite, cl.tel=:pTel, cl.dn=:pDn, cl.mail=:pMail, cl.numcb=:pNumcb, cl.mdp=:pMdp, cl.conseiller.id_co=:pId_co WHERE cl.id=:pId";
		...
		query.setParameter("pId_co", cl.getConseiller().getId_co());
