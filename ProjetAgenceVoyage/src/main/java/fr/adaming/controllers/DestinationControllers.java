...
public class DestinationControllers {
	...
	public void setImgCTRL(ImageController imgCTRL) {
	...
	public String soumettreFormModifds(@ModelAttribute("dsModif") Destination ds,
		...
		if (files.length == 0) {
			Destination dsIn = dsService.getDestinationbyId(ds.getId());
			ds.setListeImage(dsIn.getListeImage());
