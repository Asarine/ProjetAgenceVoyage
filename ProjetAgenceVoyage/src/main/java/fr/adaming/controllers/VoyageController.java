...
public class VoyageController {
	...
	//recherche voyage
	@RequestMapping(value = "/soumRech", method = RequestMethod.GET)
	public ModelAndView rechercherbymcvoy() {
		return new ModelAndView("accueil", "voyRech", new Voyage());

	}
	
	//Rechercher par Mot Cle
	@RequestMapping(value = "/soumRechvo", method = RequestMethod.POST)
	public String sourecherchebymc(Model model, @RequestParam("pMc") String mc) {
		List<Voyage> listevo = voyService.getbymotcle(mc);
		if (listevo != null) {
			model.addAttribute("vofind", listevo);
			return "accueil";
		} else {
			return "redirect:soumRech";
		}
	}
